...
(def ^:private tu-allowlist
  {"src/read/read.c"            "lexer/parser -- inherently sequential, not decomposable"
   ...
   "src/prim/core/http.c"       "HTTP layer home: parser machine + serializer + prims, one TU per layer (net.c precedent)"
   "src/prim/time/time.c"       "time/date layer home: civil core + parsers + formatters + arithmetic + prims, one TU per layer (http.c precedent)"
