...
(def ^:private suite-files
  [   "tests/test"
   ...
   "tests/bundled_manifest_test"
   "tests/bundler_parity_test"
          ...
          "tests/template_test"
            ...
            "tests/html_test"
             ...
             "tests/html_zip_test"
              ...
              "tests/html_fuzz_test"
              "tests/xml_fixture_test"
               "tests/xml_test"
               "tests/xml_perf_test"
               "tests/xml_fuzz_test"
               "tests/store_backend_test"
                "tests/http_server_codec_test"
                "tests/http_server_test"
                "tests/http_server_fuzz_test"
                "tests/fs_verbs_test"
                "tests/secure_random_test"
                "tests/signal_test"
                ...
                "tests/jsonl_test"
                "tests/mime_test"
                "tests/yaml_emit_test"
                "tests/toml_emit_test"
                "tests/xml_emit_test"
                "tests/udp_test"
                "tests/ws_test"
                ...
                "tests/prompt_test"
                "tests/with_out_str_perf_test"
                "tests/print_hook_leak_test"
                "tests/pipeline_fusion_test"])
