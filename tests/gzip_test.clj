...
;; compressor, so every round trip starts from a fixture generated by
;; python3 (see tests/fixtures/gzip/README.md).
;;
...
(defn- hello-parts
  ...
  boundaries (python writes a 10-byte no-flag header)."
  []
