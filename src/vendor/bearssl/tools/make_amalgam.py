...
out.write(" * arches).\n")
out.write(" *\n")
out.write(" * WIN32_LEAN_AND_MEAN is defined up front: the _WIN32 branches of\n")
out.write(" * ssl_engine.c and x509_minimal.c include <windows.h>, and the\n")
out.write(" * lean flag keeps winsock.h out of it (it would redefine-clash\n")
out.write(" * with the winsock2.h the net layer includes, under MSVC).\n")
out.write(" *\n")
...
out.write("/* WIN32_LEAN_AND_MEAN: see the file-top note. Inert on non-Windows\n")
out.write(" * hosts (windows.h is never included there).\n")
out.write(" */\n")
out.write("#define WIN32_LEAN_AND_MEAN\n")
