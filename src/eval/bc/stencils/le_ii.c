 ...
 *
 * OP_LE_II A B C is the specialised int<=int form of `(<= a b)`.
 * Same template as lt_ii.c with BINOP_LE as the subop.
 *
...
mino_val_t **stencil_op_le_ii(mino_val_t **regs, mino_val_t **consts,
                               mino_state_t *S)
{
    (void)consts;
