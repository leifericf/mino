 ...
 *
 * OP_GE_II A B C is the specialised int>=int form of `(>= a b)`.
 * Same template as lt_ii.c with BINOP_GE as the subop.
 *
...
mino_val_t **stencil_op_ge_ii(mino_val_t **regs, mino_val_t **consts,
                               mino_state_t *S)
{
    (void)consts;
