               ...
               mino_val *comparator)
{
    if (comparator == NULL) return val_compare(a, b);
    {
        ...
        mino_val *result = mino_call(S, comparator, args, NULL);
        mino_val *args2;
        mino_val *result2;
        ...
        args2 = mino_cons(S, (mino_val *)b,
                   mino_cons(S, (mino_val *)a, mino_nil(S)));
...
static mino_rb_node_t *rb_new(mino_state *S, mino_val *key,
                               mino_val *val, int red)
{
...
static mino_rb_node_t *rotate_left(mino_state *S, const mino_rb_node_t *h)
{
...
static mino_rb_node_t *rotate_right(mino_state *S, const mino_rb_node_t *h)
{
...
static mino_rb_node_t *flip_colors(mino_state *S, const mino_rb_node_t *h)
{
    mino_rb_node_t *hc = rb_clone(S, h);
...
static mino_rb_node_t *fixup(mino_state *S, mino_rb_node_t *h)
{
...
static mino_rb_node_t *rb_insert(mino_state *S, const mino_rb_node_t *n,
                                  mino_val *key, mino_val *val,
                                  mino_val *comparator, int *replaced)
{
    mino_rb_node_t *h;
    int cmp;
...
static mino_rb_node_t *move_red_left(mino_state *S, const mino_rb_node_t *h)
{
...
static mino_rb_node_t *move_red_right(mino_state *S, const mino_rb_node_t *h)
{
    mino_rb_node_t *hc = flip_colors(S, h);
...
static mino_rb_node_t *rb_delete_min(mino_state *S, const mino_rb_node_t *h)
{
    mino_rb_node_t *hc;
...
static mino_rb_node_t *rb_delete(mino_state *S, const mino_rb_node_t *h,
                                  const mino_val *key,
                                  mino_val *comparator)
{
    mino_rb_node_t *hc;
                ...
                mino_val **head, mino_val **tail)
{
    ...
    {
        mino_val *cell = mino_cons(S, n->key, mino_nil(S));
...
mino_val *mino_sorted_set(mino_state *S, mino_val **items, size_t len)
{
