...
void mino_install_jvm_statics(mino_state *S, mino_env *env)
{
    ...
    env_bind(S, core_env, "Double/POSITIVE_INFINITY", mino_float(S, INFINITY));
    env_bind(S, core_env, "Double/NEGATIVE_INFINITY", mino_float(S, -INFINITY));
    env_bind(S, core_env, "Double/NaN",        mino_float(S, NAN));
    env_bind(S, core_env, "Float/MAX_VALUE",   mino_float(S, 3.4028235e+38));
    env_bind(S, core_env, "Float/MIN_VALUE",   mino_float(S, 1.4e-45));
    env_bind(S, core_env, "Float/POSITIVE_INFINITY", mino_float(S, INFINITY));
    env_bind(S, core_env, "Float/NEGATIVE_INFINITY", mino_float(S, -INFINITY));
    env_bind(S, core_env, "Float/NaN",         mino_float(S, NAN));
