 ...
 * prim_require is cross-TU: called from src/eval/defs.c and src/prim/core/ns.c. */
...
mino_val *prim_parse_url(mino_state *S, mino_val *args, mino_env *env);
...
/* ws.c -- RFC 6455 frame codec + handshake; gates under MINO_CAP_WEBSOCKET. */
extern const mino_prim_def k_prims_ws[];
extern const size_t        k_prims_ws_count;
...
extern const mino_prim_def k_prims_yaml[];
extern const size_t        k_prims_yaml_count;
extern const mino_prim_def k_prims_html[];
extern const size_t        k_prims_html_count;
extern const mino_prim_def k_prims_xml[];
extern const size_t        k_prims_xml_count;
...
extern const mino_prim_def k_prims_store[];
extern const size_t        k_prims_store_count;
