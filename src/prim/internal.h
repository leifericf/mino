 ...
 * are file-local `static` functions in prim/reflection.c, generated by
 * DEFINE_TYPE_PRED / DEFINE_TYPE_PRED_NOARGV and registered via that
 * file's k_prims tables. They are used nowhere else, so they carry no
