...
#define MINO_VERSION       "2026.09.09-alpha1"
...
typedef struct {
     ...
     * barrier_dijkstra_pushes ticks for each new-value insertion push
     * during MAJOR_MARK (catches edges whose snapshot path was
